...
public class c6_CombiningPublishers extends CombiningPublishersBase {
	...
	public void prettify() {
		...
		Mono<Boolean> successful = openFile().then(writeToFile("0x3522285912341")).then(closeFile())
				.thenReturn(true);
	...
	public void acid_durability() {
		//todo: feel free to change code as you need
		Flux<String> committedTasksIds = tasksToExecute().concatMap(task -> task.flatMap(taskId -> commitTask(taskId).thenReturn(taskId)));
